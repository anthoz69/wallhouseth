...
return [
    ...
    'attributes'                     => [
        'bill_name'     => 'ชื่อ ในใบเสร็จ',
        'bill_phone'    => 'เบอร์โทรศัพท์ ในใบเสร็จ',
        'bill_country'  => 'ประเทศ ในใบเสร็จ',
        'bill_address'  => 'ที่อยู่ ในใบเสร็จ',
        'bill_zipcode'  => 'รหัสไปรษณีย์ ในใบเสร็จ',
        'bill_amphoe'   => 'อำเภอ ในใบเสร็จ',
        'bill_district' => 'ตำบล ในใบเสร็จ',
        'bill_province' => 'จังหวัด ในใบเสร็จ',

        'shipping_name'     => 'ชื่อ ในที่อยู่จัดส่ง',
        'shipping_phone'    => 'เบอร์โทรศัพท์ ในที่อยู่จัดส่ง',
        'shipping_country'  => 'ประเทศ ในที่อยู่จัดส่ง',
        'shipping_address'  => 'ที่อยู่ ในที่อยู่จัดส่ง',
        'shipping_zipcode'  => 'รหัสไปรษณีย์ ในที่อยู่จัดส่ง',
