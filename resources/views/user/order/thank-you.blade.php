            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="success-text">
                        ...
                        <h2 class="mt-5">การสั่งซื้อสำเร็จ</h2>
                        <p>การชำระเงินสำเร็จ ทางเราได้รับคำสั่งซื้อและกำลังจัดเตรียมรายการสินค้าให้คุณ</p>
                        <a href="{{ route('user.order', ['order' => $order->id]) }}" class="btn bg-primary-300 text-white">
                            ดูออเดอร์ของคุณ
                        </a>
                    </div>
                </div>
