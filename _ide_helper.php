...
')
     ...
     */ 
        class GoogleTranslateFacade {
                    /**
         * 
         *
         * @static 
         */ 
        public static function detectLanguage($input)
        {
                        /** @var \JoggApp\GoogleTranslate\GoogleTranslate $instance */
                        return $instance->detectLanguage($input);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function detectLanguageBatch($input)
        {
                        /** @var \JoggApp\GoogleTranslate\GoogleTranslate $instance */
                        return $instance->detectLanguageBatch($input);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function translate($input, $from = null, $to = null, $format = 'text')
        {
                        /** @var \JoggApp\GoogleTranslate\GoogleTranslate $instance */
                        return $instance->translate($input, $from, $to, $format);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function justTranslate($input, $from = null, $to = null)
        {
                        /** @var \JoggApp\GoogleTranslate\GoogleTranslate $instance */
                        return $instance->justTranslate($input, $from, $to);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function translateBatch($input, $translateFrom, $translateTo, $format = 'text')
        {
                        /** @var \JoggApp\GoogleTranslate\GoogleTranslate $instance */
                        return $instance->translateBatch($input, $translateFrom, $translateTo, $format);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getAvaliableTranslationsFor($languageCode)
        {
                        /** @var \JoggApp\GoogleTranslate\GoogleTranslate $instance */
                        return $instance->getAvaliableTranslationsFor($languageCode);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function unlessLanguageIs($languageCode, $input, $from = null, $to = null)
        {
                        /** @var \JoggApp\GoogleTranslate\GoogleTranslate $instance */
                        return $instance->unlessLanguageIs($languageCode, $input, $from, $to);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function sanitizeLanguageCode($languageCode)
        {
                        /** @var \JoggApp\GoogleTranslate\GoogleTranslate $instance */
                        return $instance->sanitizeLanguageCode($languageCode);
        }
                    /**
         * 
         *
...
namespace  { 
            ...
            class GoogleTranslate extends \JoggApp\GoogleTranslate\GoogleTranslateFacade {}
